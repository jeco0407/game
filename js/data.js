...
const DATA = {
  ...
  recaps: {
    1: {
      ...
      paragraphs: [
        ...
        '那個人，用的帳號叫「灰 hui_0917」。',
        '你追出這個帳號背後真正在使用的人，是林予安身邊一個叫陳奕辰的人。但當你以為案件快要結束的時候，系統告訴你一件更奇怪的事：「灰」從來不是一個固定的名字，而是一長串編號中的一個——從 1 到 128，一路遞補下去。',
        '而現在，128 之後的下一個編號，是你。你是灰-129。',
      ],
    ...
    3: {
      ...
      paragraphs: [
        ...
        '你也找到林予安留下的兩份訊息，依時間排列後看出她心境的轉折：從「不要相信灰」的警告，到「不要試著離開」的接受。',
        '灰之鏈延伸到了灰-129、灰-130。你最終確認：灰-130，不是另一個調查者，而是正在調查灰-129（也就是你）的人。',
      ],
      closing: '案件結案。調查者：灰-130。狀態：使用中。你離開案件的那一刻，系統已經建立灰-131，開始新一輪調查。它是誰，沒有人知道。',
    },
  },
  ...
  case0642: {
    intro: [
      '這是一段被封存的私訊紀錄，對象身分已從系統中移除。',
      '灰-131 已對這份封存建立觀察紀錄——這是自它啟用以來，第一次有人打開它。',
    ],
    messages: [
      { id: 1, sentTime: '21:03', createdTime: '21:03', text: '還在嗎？' },
      { id: 2, sentTime: '21:07', createdTime: '21:07', text: '我需要你幫我一件事。' },
      { id: 3, sentTime: '21:11', createdTime: '21:11', text: '不能在這裡說。' },
      { id: 4, sentTime: '21:15', createdTime: '21:15', text: '先刪掉這則。' },
      { id: 5, sentTime: '21:19', createdTime: '20:41', text: '如果有人問起，你什麼都沒看到。' },
      { id: 6, sentTime: '21:23', createdTime: '21:23', text: '好。' },
      { id: 7, sentTime: '21:27', createdTime: '21:27', text: '謝謝。' },
    ],
    anomalyId: 5,
    result: {
      title: '封存不一致',
      lines: [
        '1 則訊息的建立時間，早於這段對話開始的時間。',
        '原始作者：不明',
        '封存持有人：不明',
        '回溯來源：灰資料庫',
        '灰參照：灰-131',
      ],
      closing: '案件 #0642 尚未解決。片段 01 · 完。',
    },
  },
  ...
  hints: {
    ...
    case0642: [
      '訊息顯示的時間，不一定是它真正被建立的時間。',
      '點開每一則訊息，比對它的建立時間跟顯示順序合不合理。',
      '有一則訊息的建立時間，比第一則訊息還早——它是在對話開始之前就被寫好的。',
    ],
  }
};
